...
function RequestFilter({ onClickClose }) {
    ...
    return (
        <Box sx={{ backgroundColor: theme.palette.background.paper }} className="shadow-lg w-3/5 h-screen rounded-3xl px-4 py-5 overflow-y-scroll none-view-scroll max-sm:w-4/5 max-sm:translate-x-0 max-sm:left-0 relative" dir="rtl">
            ...
            <Box className="">
                <Box className="flex justify-between items-center border-2 rounded-lg py-1 px-2 mt-4">
            ...
            <Box className="flex justify-between mt-5 max-sm:flex-col">
                <Box className="w-2/5 max-sm:w-full">
                    ...
                    <input type="date" className="mt-2 w-full rounded-lg h-10 bg-gray-200 px-2" value="2025-07-12"/>
                </Box>
                <Box className="w-2/5 max-sm:w-full">
            ...
            <Box className="">
                <input className="mt-2 w-full h-10 rounded-lg border bg-gray-200 indent-3" placeholder="أدخل اسم الدورة"/>
            </Box>
