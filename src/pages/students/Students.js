                                        ...
                                        <Box className="min-h-12 py-2 px-2 flex justify-between items-center">
                                            <Box className="w-full flex items-center">
                                                ...
                                                <Box className="w-2/4 relative mr-3">
                                                    <input style={{ backgroundColor: theme.palette.background.default }} onChange={(e) => setSearch(e.target.value)} className="w-10/12 h-12 rounded-md border indent-14 outline-none" placeholder="البحث بالاسم الثلاثي أو البريد الإلكتروني" />
